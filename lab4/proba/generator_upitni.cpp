...
void greska(int dubina_produkcije);
void primarni_izraz(string &tip, bool &l_izraz, int &vrijednost);
void izraz(string &tip, bool &l_izraz, int &vrijednost);
void postfiks_izraz(string &tip, bool &l_izraz, int &vrijednost);
...
void cast_izraz(string &tip, bool &l_izraz, int &vrijednost);
void unarni_izraz(string &tip, bool &l_izraz, int &vrijednost);
void ime_tipa(string &tip);
void specifikator_tipa(string &tip);
void multiplikativni_izraz(string &tip, bool &l_izraz, int &vrijednost);
void aditivni_izraz(string &tip, bool &l_izraz, int &vrijednost);
void odnosni_izraz(string &tip, bool &l_izraz, int &vrijednost);
void jednakosni_izraz(string &tip, bool &l_izraz, int &vrijednost);
void bin_i_izraz(string &tip, bool &l_izraz, int &vrijednost);
void bin_xili_izraz(string &tip, bool &l_izraz, int &vrijednost);
void bin_ili_izraz(string &tip, bool &l_izraz, int &vrijednost);
void log_i_izraz(string &tip, bool &l_izraz, int &vrijednost);
void log_ili_izraz(string &tip, bool &l_izraz, int &vrijednost);
void izraz_pridruzivanja(string &tip, bool &l_izraz, int &vrijednost);
void izraz(string &tip, bool &l_izraz, int &vrijednost);
...
void izraz(string &tip, bool &l_izraz, int &vrijednost) {
   ...
   iduca_linija();
   if (ulaz.izraz == "<izraz_pridruzivanja>") {
      izraz_pridruzivanja(tip, l_izraz, vrijednost);
   }
   else if (ulaz.izraz == "<izraz>") {
      izraz(tip, l_izraz);
      iduca_linija();
